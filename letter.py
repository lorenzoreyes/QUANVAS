...
for i in range(1,len(clients)):
    ...
    text = """<h1>Bienvenido a QUANVAS.</h1><h3>Es momento de automatizar sus ahorros, saber que está pasando en el mercado, que opciones hay a disposición y como ejecutarlas.<br /></h3>"""
    detalle = """<h3>
              <ul>
